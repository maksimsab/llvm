...
; split if it was disabled through one or another SYCL Module Splitter option

; FIXME: ESIMD Lowering hasn't been moved to library yet.
;        Hence, this test is failing until then.

; rUN: sycl-module-split -S < %s -o %t
...
; specified
; rUN: sycl-module-split -lower-esimd -ir-output-only -S < %s -o %t.ll
